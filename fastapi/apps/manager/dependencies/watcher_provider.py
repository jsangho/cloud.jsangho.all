...
from manager.adapter.outbound.repositories.watcher_repository import WatcherPgRepository
from manager.app.ports.input.watcher_use_case import WatcherUseCase
from manager.app.use_cases.watcher_interactor import WatcherInteractor
