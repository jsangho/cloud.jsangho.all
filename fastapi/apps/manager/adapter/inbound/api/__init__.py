...
from manager.adapter.inbound.api.v1.judge_router import judge_router
from manager.adapter.inbound.api.v1.juso_router import juso_router
from manager.adapter.inbound.api.v1.receiver_router import receiver_router
from manager.adapter.inbound.api.v1.telegram_router import telegram_router
from manager.adapter.inbound.api.v1.watcher_router import watcher_router
