...
ROSTER: tuple[RosterMember, ...] = (
    ...
    RosterMember("군터", _M, _ME, 0, 520, 16),
    RosterMember("데미언 프리스트", _M, _ME, 0, 260, 21),
    RosterMember("드류 매킨타이어", _M, _ME, 0, 364, 19),
    RosterMember("랜디 오턴", _M, _ME, 0, 156, 24),
    RosterMember("레이 미스테리오", _M, _ME, 0, 156, 29),
    ...
    RosterMember("루트비히 카이저", _M, _MC, 0, 676, 13),
    ...
    RosterMember("션 레거시", _M, _P, 0, 936, 8),
    ...
    RosterMember("잭슨 드레이크", _M, _P, 0, 832, 10),
    RosterMember("조시 브릭스", _M, _P, 0, 780, 11),
    ...
    RosterMember("키아누 카버", _M, _P, 0, 832, 10),
    RosterMember("탱크 레저", _M, _P, 0, 1144, 4),
    RosterMember("테이비언 하이츠", _M, _P, 0, 988, 7),
    RosterMember("토니 단젤로", _M, _P, 0, 884, 9),
    RosterMember("트리스탄 에인절스", _M, _P, 0, 1300, 1),
    RosterMember("행크 워커", _M, _P, 0, 1040, 6),
    # ── 남성부 · 1년차 데뷔 ────────────────────────────
    RosterMember("디온 스파크", _M, _MC, 52, 1300, 6),
    RosterMember("에런 루크", _M, _P, 52, 988, 8),
    RosterMember("잇츠 갈", _M, _P, 52, 1300, 2),
    RosterMember("잭스 프레슬리", _M, _P, 52, 1196, 4),
    ...
    RosterMember("브랙스턴 콜", _M, _P, 104, 936, 10),
    RosterMember("브랜든 서머스", _M, _P, 104, 1352, 0),
    RosterMember("카푸치노 존스", _M, _P, 104, 1404, 1),
    # ── 남성부 · 3년차 데뷔 ────────────────────────────
    RosterMember("디온 프로스트", _M, _MC, 156, 1404, 6),
    RosterMember("데본 서머스", _M, _P, 156, 1404, 0),
    RosterMember("스타보이 찰리", _M, _P, 156, 1456, 1),
    RosterMember("자비어 리버스", _M, _P, 156, 1404, 0),
    RosterMember("할렘 루이스", _M, _P, 156, 1300, 4),
    # ── 남성부 · 4년차 데뷔 ────────────────────────────
    RosterMember("PJ 바사", _M, _P, 208, 1040, 10),
    ...
    # ── 여성부 · 0주차 명부 ────────────────────────────
    RosterMember("나오미", _F, _ME, 0, 520, 16),
    RosterMember("니아 잭스", _F, _ME, 0, 312, 20),
    RosterMember("레아 리플리", _F, _ME, 0, 988, 7),
    RosterMember("리브 모건", _F, _ME, 0, 832, 10),
    RosterMember("베일리", _F, _ME, 0, 572, 15),
    RosterMember("베키 린치", _F, _ME, 0, 468, 17),
    RosterMember("비앙카 벨레어", _F, _ME, 0, 572, 15),
    RosterMember("샬럿 플레어", _F, _ME, 0, 416, 18),
    RosterMember("스테파니 바케르", _F, _ME, 0, 780, 11),
    RosterMember("아스카", _F, _ME, 0, 208, 22),
    RosterMember("알렉사 블리스", _F, _ME, 0, 676, 13),
    RosterMember("이요 스카이", _F, _ME, 0, 624, 14),
    RosterMember("제이드 카길", _F, _ME, 0, 832, 10),
    RosterMember("줄리아", _F, _ME, 0, 832, 10),
    RosterMember("티파니 스트래튼", _F, _ME, 0, 1092, 5),
    RosterMember("AJ 리", _F, _MC, 0, 468, 17),
    RosterMember("B-팹", _F, _MC, 0, 676, 13),
    RosterMember("내티", _F, _MC, 0, 208, 22),
    RosterMember("니키 벨라", _F, _MC, 0, 312, 20),
    RosterMember("라이라 발키리아", _F, _MC, 0, 988, 7),
    RosterMember("라켈 로드리게스", _F, _MC, 0, 676, 13),
    RosterMember("래시 레전드", _F, _MC, 0, 988, 7),
    RosterMember("레이니 리드", _F, _MC, 0, 1092, 5),
    RosterMember("록산 페레즈", _F, _MC, 0, 1248, 2),
    RosterMember("맥신 듀프리", _F, _MC, 0, 988, 7),
    RosterMember("미친", _F, _MC, 0, 572, 15),
    RosterMember("브리 벨라", _F, _MC, 0, 312, 20),
    RosterMember("블레이크 먼로", _F, _MC, 0, 1040, 6),
    RosterMember("솔 루카", _F, _MC, 0, 1144, 4),
    RosterMember("아이비 나일", _F, _MC, 0, 728, 12),
    RosterMember("제이시 제인", _F, _MC, 0, 936, 8),
    RosterMember("조딘 그레이스", _F, _MC, 0, 832, 10),
    RosterMember("첼시 그린", _F, _MC, 0, 676, 13),
    RosterMember("캔디스 르레이", _F, _MC, 0, 416, 18),
    RosterMember("키아나 제임스", _F, _MC, 0, 988, 7),
    RosterMember("파이퍼 니븐", _F, _MC, 0, 676, 13),
    RosterMember("팰런 헨리", _F, _MC, 0, 884, 9),
    RosterMember("페이지", _F, _MC, 0, 780, 11),
    RosterMember("니키타 라이온스", _F, _P, 0, 1092, 5),
    RosterMember("레이나 볼칸", _F, _P, 0, 988, 7),
    RosterMember("레일라 딕스", _F, _P, 0, 832, 10),
    RosterMember("렌 싱클레어", _F, _P, 0, 884, 9),
    RosterMember("롤라 바이스", _F, _P, 0, 1040, 6),
    RosterMember("리지 레인", _F, _P, 0, 1040, 6),
    RosterMember("마이카 록우드", _F, _P, 0, 1196, 3),
    RosterMember("스카일라 레이", _F, _P, 0, 1196, 3),
    RosterMember("시아 헤일", _F, _P, 0, 1352, 0),
    RosterMember("아드리아나 리조", _F, _P, 0, 1092, 5),
    RosterMember("아리아나 그레이스", _F, _P, 0, 884, 9),
    RosterMember("웬디 추", _F, _P, 0, 728, 12),
    RosterMember("이지 데임", _F, _P, 0, 1092, 5),
    RosterMember("자리아", _F, _P, 0, 1092, 5),
    RosterMember("자이다 파커", _F, _P, 0, 1092, 5),
    RosterMember("카르멘 페트로비치", _F, _P, 0, 936, 8),
    RosterMember("칼리 암스트롱", _F, _P, 0, 832, 10),
    RosterMember("켄달 그레이", _F, _P, 0, 1196, 3),
    RosterMember("켈라니 조던", _F, _P, 0, 1092, 5),
    RosterMember("테이텀 팩슬리", _F, _P, 0, 988, 7),
    # ── 여성부 · 1년차 데뷔 ────────────────────────────
    RosterMember("스칼렛 서머스", _F, _MC, 52, 1300, 6),
    RosterMember("엠버 바이퍼", _F, _P, 52, 1300, 0),
    RosterMember("지나 스털링", _F, _P, 52, 1404, 0),
    # ── 여성부 · 2년차 데뷔 ────────────────────────────
    RosterMember("이든 폭스", _F, _P, 104, 1352, 0),
    RosterMember("이자벨 퀸", _F, _P, 104, 1352, 0),
    RosterMember("카이 카바리", _F, _P, 104, 936, 10),
    # ── 여성부 · 3년차 데뷔 ────────────────────────────
    RosterMember("마야 나이트", _F, _MC, 156, 1404, 6),
    RosterMember("아리아 베넷", _F, _P, 156, 1040, 9),
    RosterMember("케일라 레인", _F, _P, 156, 1404, 0),
    # ── 여성부 · 4년차 데뷔 ────────────────────────────
    RosterMember("델라니 스톰", _F, _P, 208, 1456, 0),
    RosterMember("샹텔 먼로", _F, _P, 208, 1352, 4),
    RosterMember("케일라 하트", _F, _P, 208, 1456, 0),
    # ── 여성부 · 5년차 데뷔 ────────────────────────────
    RosterMember("테사 리드", _F, _MC, 260, 1508, 6),
    RosterMember("케일라 스파크", _F, _P, 260, 1508, 0),
    # ── 여성부 · 6년차 데뷔 ────────────────────────────
    RosterMember("마야 스톰", _F, _P, 312, 1560, 0),
    RosterMember("스칼렛 폭스", _F, _P, 312, 1560, 0),
    # ── 여성부 · 7년차 데뷔 ────────────────────────────
    RosterMember("케일라 헤이즈", _F, _MC, 364, 1612, 6),
    RosterMember("이든 벨", _F, _P, 364, 1612, 0),
    # ── 여성부 · 8년차 데뷔 ────────────────────────────
    RosterMember("리아 파울러", _F, _P, 416, 1664, 0),
    RosterMember("조이 크로스", _F, _P, 416, 1664, 0),
    # ── 여성부 · 9년차 데뷔 ────────────────────────────
    RosterMember("이자벨 블레이즈", _F, _MC, 468, 1716, 6),
    RosterMember("마야 크로스", _F, _P, 468, 1716, 0),
    # ── 여성부 · 10년차 데뷔 ───────────────────────────
    RosterMember("델라니 폭스", _F, _P, 520, 1768, 0),
    RosterMember("브룩 블레이즈", _F, _P, 520, 1768, 0),
    # ── 여성부 · 11년차 데뷔 ───────────────────────────
    RosterMember("노바 리드", _F, _MC, 572, 1820, 6),
    RosterMember("아이비 헌터", _F, _P, 572, 1820, 0),
    # ── 여성부 · 12년차 데뷔 ───────────────────────────
    RosterMember("시에나 나이트", _F, _P, 624, 1872, 0),
    RosterMember("카일라 레인", _F, _P, 624, 1872, 0),
    # ── 여성부 · 13년차 데뷔 ───────────────────────────
    RosterMember("이자벨 밴스", _F, _MC, 676, 1924, 6),
    RosterMember("하퍼 프로스트", _F, _P, 676, 1924, 0),
    # ── 여성부 · 14년차 데뷔 ───────────────────────────
    RosterMember("노바 프라이스", _F, _P, 728, 1976, 0),
    RosterMember("미셸 헤이즈", _F, _P, 728, 1976, 0),
    # ── 여성부 · 15년차 데뷔 ───────────────────────────
    RosterMember("엠버 스틸", _F, _MC, 780, 2028, 6),
    RosterMember("애슐리 윈터스", _F, _P, 780, 2028, 0),
    # ── 여성부 · 16년차 데뷔 ───────────────────────────
    RosterMember("리아 라이커", _F, _P, 832, 2080, 0),
    RosterMember("테사 케이지", _F, _P, 832, 2080, 0),
    # ── 여성부 · 17년차 데뷔 ───────────────────────────
    RosterMember("브리아나 레인", _F, _MC, 884, 2132, 6),
    RosterMember("이든 울프", _F, _P, 884, 2132, 0),
    # ── 여성부 · 18년차 데뷔 ───────────────────────────
    RosterMember("리아 헤이즈", _F, _P, 936, 2184, 0),
    RosterMember("조던 리드", _F, _P, 936, 2184, 0),
    # ── 여성부 · 19년차 데뷔 ───────────────────────────
    RosterMember("조이 브릭스", _F, _MC, 988, 2236, 6),
    RosterMember("하퍼 서머스", _F, _P, 988, 2236, 0),
    # ── 여성부 · 20년차 데뷔 ───────────────────────────
    RosterMember("조이 셰이드", _F, _P, 1040, 2288, 0),
    RosterMember("하퍼 폭스", _F, _P, 1040, 2288, 0),
    # ── 여성부 · 21년차 데뷔 ───────────────────────────
    RosterMember("리네아 폭스", _F, _MC, 1092, 2340, 6),
    RosterMember("페이 셰이드", _F, _P, 1092, 2340, 0),
    # ── 여성부 · 22년차 데뷔 ───────────────────────────
    RosterMember("마야 레인", _F, _P, 1144, 2392, 0),
    RosterMember("시에나 벨", _F, _P, 1144, 2392, 0),
    # ── 여성부 · 23년차 데뷔 ───────────────────────────
    RosterMember("스칼렛 라이커", _F, _MC, 1196, 2444, 6),
    RosterMember("리네아 나이트", _F, _P, 1196, 2444, 0),
    # ── 여성부 · 24년차 데뷔 ───────────────────────────
    RosterMember("엠버 밴스", _F, _P, 1248, 2496, 0),
    RosterMember("조이 라이커", _F, _P, 1248, 2496, 0),
    # ── 여성부 · 25년차 데뷔 ───────────────────────────
    RosterMember("노바 프로스트", _F, _MC, 1300, 2548, 6),
    RosterMember("스칼렛 세이지", _F, _P, 1300, 2548, 0),
    # ── 여성부 · 26년차 데뷔 ───────────────────────────
    RosterMember("애슐리 스틸", _F, _P, 1352, 2600, 0),
    RosterMember("이든 서머스", _F, _P, 1352, 2600, 0),
    # ── 여성부 · 27년차 데뷔 ───────────────────────────
    RosterMember("애슐리 브릭스", _F, _MC, 1404, 2652, 6),
    RosterMember("아이비 셰이드", _F, _P, 1404, 2652, 0),
    # ── 여성부 · 28년차 데뷔 ───────────────────────────
    RosterMember("로렌 리버스", _F, _P, 1456, 2704, 0),
    RosterMember("마야 하트", _F, _P, 1456, 2704, 0),
    # ── 여성부 · 29년차 데뷔 ───────────────────────────
    RosterMember("아이비 헤이즈", _F, _MC, 1508, 2756, 6),
    RosterMember("하퍼 브릭스", _F, _P, 1508, 2756, 0),
    # ── 여성부 · 30년차 데뷔 ───────────────────────────
    RosterMember("미셸 벨", _F, _P, 1560, 2808, 0),
    RosterMember("카일라 셰이드", _F, _P, 1560, 2808, 0),
)
